...
```{r xaringan-tile-view, echo=FALSE, cache=FALSE}
xaringanExtra::use_tile_view()
```

```{r xaringan-clipboard, echo=FALSE, cache=FALSE}
xaringanExtra::use_clipboard()
```

```{r xaringan-editable, echo=FALSE, cache=FALSE}
xaringanExtra::use_editable(expires = 1)
```

```{r xaringan-extra, echo=FALSE, cache=FALSE}
...
.font80[`r params$occasion`<br /> `r params$place` <br /> `r params$date`]
