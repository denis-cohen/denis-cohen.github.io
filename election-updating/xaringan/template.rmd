...
author: "Denis Cohen, Daniel Auer & Sandra Morgenstern"
...
<td>Denis Cohen</td>
<td>Daniel Auer</td>
<td>Sandra N. Morgenstern</td>
</tr>
<tr>
<td>.font80[University of Mannheim]</td>
<td>.font80[Collegio Carlo Alberto]</td>
<td>.font80[University of Mannheim]</td>
</tr>
</tbody>
</table>
...
<td>`r fontawesome::fa("envelope")` <code>daniel.auer@carloalberto.org</code></td>
<td>`r fontawesome::fa("envelope")` <code>morgenstern@uni-mannheim.de</code></td>
</tr>
<tr>
<td>`r fontawesome::fa("bluesky")` <code>@denis-cohen@bsky.social</code></td>
<td>`r fontawesome::fa("bluesky")` <code>@danielauer@bsky.social</code></td>
<td>`r fontawesome::fa("bluesky")` <code>@snmorgenstern@bsky.social</code></td>
</tr>
<tr>
<td>`r fontawesome::fa("globe")` <code>denis-cohen.github.io</code></td>
<td>`r fontawesome::fa("globe")` <code>daniel-auer.com</code></td>
<td>`r fontawesome::fa("globe")` <code>sandramorgenstern.com</code></td>
</tr>
</tbody>
</table>
...
```{r copy-figures, cache=FALSE}
fs::dir_copy(fig_path, paste0("../", fig_path), overwrite = TRUE)
```
